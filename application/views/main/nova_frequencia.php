                            ...
                            <div class="panel-body">
                                 ...
                                 <div class="row">
                                	<div class="col-md-2">
                                		<div class="form-group">
                                			<label>Data : </label>
											<input type="text" name="p#data" value="" class="form-control" />
                                		</div>                                		
                                	</div>
                                <div class="col-lg-1">
                                    <div class="form-group">
                                            <label>Hora: </label>
                                            <input type="text" class="form-control" required  name="p#hora" placeholder="" />
                                    </div>
                                </div>
                                </div>
                               ...
                               <div class="col-lg-5">
                                    <div class="form-group">
                                            ...
                                            <textarea class="form-control" required  name="p#descricao" placeholder="Sessão ordinária"></textarea>
                                    </div>
                                </div>
                                </div>
