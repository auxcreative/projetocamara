  ...
  <div class="tab-content">
                        ...
                        <div class="panel panel-default"m style="height: auto">
                            <div class="panel-body">
                               	...
                               	<div class="row">
                               		<div class="col-md-2">
                               			<div class="form-group">
                               				...
                               				<input type="text" name="p#code" class="form-control text-center"  value="<?php echo $noticia->code;  ?>" readonly="" />
                               			</div>
                               		</div>
                               		...
                               		<div class="col-md-2">
                               			<div class="form-group">
                               				...
                               				<input type="text" name="p#data_postagem" value="<?php echo arruma_data($noticia->data_postagem);  ?>" class="form-control" />
                               			</div>
                               		</div>
                               <div class="col-md-1">                                   
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="p#status" value="n"<?php echo  ($noticia->status == 'n') ?'checked': '';  ?>>Edição
                                                </label>
                                            </div>
                               </div>
                                <?php 
                               ...
                               <div class="col-md-1">                         
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="p#status" value="p" <?php echo  ($noticia->status == 'p') ?'checked': '';  ?>>Publicar
                                                </label>
                                            </div>
                                </div>	
                                <?php endif; ?>
                                ...
                                <div class="col-lg-12">
                                	<div class="form-group">
                                            <label>Titulo: </label>
                                            <input class="form-control" required  name="p#titulo" placeholder="" value="<?php echo  $noticia->titulo;  ?>">
                                        </div>
                                </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                	<div class="form-group">
                                            <label>Resumo:</label> <small>Como vai aparecer na página principal do portal</small>
                                            <textarea name="p#resumo" class="form-control" rows="2"><?php echo  $noticia->resumo;  ?></textarea>
                                    </div>                          
                                </div>
                                </div>
                                <div class="row">
    ...
    <div role="tabpanel" <?php echo ($this->session->userdata('tab') == 'active') ? 'class=" tab-pane active"' : 'class="tab-pane"'; ?>   id="image">
    	<div class="row">
    		<div class="col-md-12">
    			<form  action="<?php echo base_url('main/noticias/banco_de_imagem/'.$this->uri->segment(4));  ?>" method="POST" enctype="multipart/form-data">
    			<div class="row">
    				<div class="col-md-5">
    					<div class="form-group">
    					<input type="hidden" name="p#code" value="<?php echo $noticia->code; ?>" />
