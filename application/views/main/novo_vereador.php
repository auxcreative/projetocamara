                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-newspaper-o"></i> Novo Vereador
                            </li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                    	<div class="col-lg-6">
                                    		<div class="form-group">
                                    			...
                                    			<input type="text" name="p#logradouro" class="form-control" placeholder="Rua x, 1001, Centro" />
                                    		</div>
                                    	</div>
                                    	                                    	<div class="col-lg-2">
                                    		<div class="form-group">
                                    			<label>CEP</label>
                                    			<input type="text" name="p#cep" class="form-control" placeholder="65620-000" />
                                    		</div>
                                    	</div>
                                    	<div class="col-lg-3">
                                    		<div class="form-group">
                                    			<label>Cidade (UF)</label>
                                    			<input type="text" name="p#cidade" class="form-control" placeholder="Coelho Neto (MA)" />
                                    		</div>
                                    	</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="p#lideranca_partido" value="S" />Sim
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="p#lideranca_partido" value="N" checked="" />Não
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="p#status" value="A" checked="" />Ativo
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="p#status" value="D" />Desligado
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
